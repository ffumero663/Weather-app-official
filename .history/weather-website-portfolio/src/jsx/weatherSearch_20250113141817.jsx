...
function WeatherSearch() {
  ...
  const fetchSuggestions = useCallback(
    debounce(async (input) => {
      ...
      const endpoint = `http://api.openweathermap.org/geo/1.0/direct?q=${input}&limit=5&appid=${apiKey}`;
  ...
  const handleSuggestionClick = async (suggestion) => {
    ...
    const apiKey = "605e4cd6a27bd010207c1df8c2774b40"; // Replace with your valid API key
    const endpoint = `http://api.openweathermap.org/data/2.5/weather?lat=${suggestion.lat}&lon=${suggestion.lon}&appid=${apiKey}&units=metric`;
